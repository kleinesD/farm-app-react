...
exports.getMilkQualityRecords = catchAsync(async(req, res, next) => {
...
exports.getOneMilkQualityRecord = catchAsync(async(req, res, next) => {
  const record = await MilkQuality.findById(req.params.id);
