...
const ResultsGraph: React.FC<ResultsGraphProps> = ({ results }) => {
  ...
  const data = results.map((res: any) => { return { date: new Date(res.date), value: res.result } });
    ...
    <svg width={width} height={height}>
      ...
      {tooltipData && (
        <TooltipInPortal top={tooltipTop} left={tooltipLeft} className="ac-graph-tooltip">
          ...
          <div className="ac-graph-tooltip-res">{tooltipData.value} л.</div>
